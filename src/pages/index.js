...
const IndexPage = () => (
  <Layout>
    ...
    <section className="textCalloutSection sectionTitle">
      <h2>Who we are</h2><hr />
      <h4><p>Grounded IT is an information technology consulting company looking to help IT professionals grow their skills and meet the goals of their IT portfolios. The rapid pace of IT innovation has organizations struggling to balance long-term investments with impact as soon as possible.</p></h4>
      <br />
      <h2>What we do</h2><hr />
      <h4><p>Grounded IT's targeted, tailored, fixed-fee offerings are designed to provide IT organizations a boost towards achieving common IT initiatives in the industry. While teams are being assembled, Grounded IT's offerings can provide a foundation for educating and accelerating groups towards IT objectives without the costs and delays associated with hiring and onboarding. With Grounded IT's expertise in cloud services, the results can be quickly transferred to IT staff onsite to contiue the progress.</p></h4>
      <br />
